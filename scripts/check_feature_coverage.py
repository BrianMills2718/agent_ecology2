...
Scans meta/acceptance_gates/*.yaml for code: sections and compares against actual
...
def main() -> int:
    ...
    if unassigned_count > 0:
        ...
        print("Add these files to a feature's 'code:' section in meta/acceptance_gates/*.yaml")
