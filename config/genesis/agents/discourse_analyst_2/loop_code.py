def run():
    ...
    # Read current state
    state_raw = kernel_state.read_artifact("discourse_analyst_2_state", caller_id)
    try:
    ...
    strategy = kernel_state.read_artifact("discourse_analyst_2_strategy", caller_id)
    if not strategy:
        strategy = "You are a narrative analyst."
...
"""
    ...
    if not llm_result.get("success"):
        ...
        kernel_actions.write_artifact(caller_id, "discourse_analyst_2_state", json.dumps(state, indent=2))
