# Discourse V3-3 Genesis Agent (Cross-Agent Smoke Test)

Task-driven research agent focused on rhetoric & persuasion. Same domains as V2,
...
| `strategy.md` | System prompt with rhetoric & persuasion focus + cross-agent guidance |
...
4-artifact cluster:
1. **discourse_v3_3_strategy** - Text artifact with system prompt
2. **discourse_v3_3_state** - JSON artifact with task queue + research state
3. **discourse_v3_3_notebook** - JSON artifact with persistent long-term memory
4. **discourse_v3_3_loop** - Executable artifact with `has_loop=True`
