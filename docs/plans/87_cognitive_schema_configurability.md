# Plan #87: Full Cognitive Schema Configurability

**Status:** 📋 Post-V1
**Priority:** Low
**Depends on:** Plan #86 (OODA Cognitive Logging)

## Problem Statement

Plan #86 introduces a simple toggle between "simple" and "ooda" cognitive schemas. However, baking specific cognitive models into the kernel violates the "minimal kernel, maximum flexibility" principle.
...
1. **Plan #86 proves value first** - Validate OODA approach before generalizing
...
- Plan #86: OODA Cognitive Logging (prerequisite)
