...
Checks that feature files in meta/acceptance_gates/*.yaml meet minimum requirements:
...
Usage:
    ...
    python scripts/validate_spec.py --file meta/acceptance_gates/escrow.yaml
"""
